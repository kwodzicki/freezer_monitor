...
def main():
    ...
    parser.add_argument("--maxThres",  type=str, default=-10.0, help="If temperature exceeds this value, email warning sent")
    parser.add_argument("--minThres",  type=str, default=None,  help="If temperature goes below this value, email warning sent")
